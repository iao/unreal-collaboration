...
void ANetworkingTestCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Bind fire event
	PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &ANetworkingTestCharacter::OnFire);
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &ANetworkingTestCharacter::TurnAtRate);
...
//void ANetworkingTestCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
