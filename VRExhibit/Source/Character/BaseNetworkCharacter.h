...
protected:
	...
	/** The skeletal meshes */
	UPROPERTY(ReplicatedUsing = OnRep_Hair, EditAnywhere, BlueprintReadWrite, Category = PlayerInfo)
		USkeletalMesh* Hair;

	UPROPERTY(ReplicatedUsing = OnRep_Head, EditAnywhere, BlueprintReadWrite, Category = PlayerInfo)
		USkeletalMesh* Head;

	UPROPERTY(ReplicatedUsing = OnRep_Chest, EditAnywhere, BlueprintReadWrite, Category = PlayerInfo)
		USkeletalMesh* Chest;

	UPROPERTY(ReplicatedUsing = OnRep_Arm, EditAnywhere, BlueprintReadWrite, Category = PlayerInfo)
		USkeletalMesh* Arm;

	UPROPERTY(ReplicatedUsing = OnRep_Leg, EditAnywhere, BlueprintReadWrite, Category = PlayerInfo)
		USkeletalMesh* Leg;
